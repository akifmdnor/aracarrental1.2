...
<head>
    ...
    <title>ARA Car Rental | Your Affordable Journey Begins Here</title>
    <link rel="stylesheet" href="{{ mix('assets/bootstrap/css/bootstrap.min.css') }}">
    <link rel="stylesheet"
        href="https://fonts.googleapis.com/css?family=Montserrat:100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i">
    <link rel="stylesheet" href="{{ mix('assets/fonts/ionicons.min.css') }}">
    <link rel="stylesheet" href="{{ mix('assets/css/date_picker.css') }}">
                    ...
                    <div class="row">
                        <div class="col checkbox-col">
                            <div class="custom-control custom-checkbox"><input
                                    class="custom-control-input checkbox-box" type="checkbox" id="LocationOpt"><label
                                    class="custom-control-label checkbox-label" for="LocationOpt">Return car at
